export default `<mjml>
  <mj-head>
    <mj-title>Booking Confirmed</mj-title>
    <mj-attributes>
      <mj-all
  ...
  <mj-body background-color="#f4f4f5">
    <mj-wrapper background-color="white" border-radius="8px" padding="30px 20px">
      <mj-section>
        <mj-column>
          <mj-text align="center" font-weight="bold" font-size="24px" padding-top="20px"> Booking Confirmed </mj-text>
      ...
      <mj-section padding="0">
        <mj-column border="1px solid #e5e7eb" border-radius="8px" padding="10px">
          <mj-text font-weight="bold" padding-bottom="5px"> {{eventTitle}} </mj-text>
          <mj-text color="#71717a" font-size="14px" padding-top="0"> with {{hostName}} </mj-text>
